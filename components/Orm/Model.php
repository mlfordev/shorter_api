...
class Model implements Serializable
{
    ...
    {
        return static::getFieldsManager()->getFieldsList();
    }

    public function getAttributesList()
    {
        return static::getFieldsManager()->getAttributesList();
    }

    public function getPkField()
    {
        return static::getFieldsManager()->getPkField();
    }

    public function getPkAttribute()
    {
        return static::getFieldsManager()->getPkAttribute();
    }
    ...
    {
        $fields = [];
        $names = static::getFieldsManager()->getFieldsList();
    ...
    public function fetchField($name)
    {
        ...
        return static::getFieldsManager()->getField($name);
    }
    ...
    {
        return static::getFieldsManager()->hasField($name);
    }
    ...
    {
        $manager = static::getFieldsManager();
        $withData = [];
    ...
    {
        return static::getFieldsManager()->getFieldValue($this, $field);
    }
    ...
    protected function _provideEvent($eventName)
    {
        ...
        $fields = static::getFieldsManager()->getFields();
    ...
    {
        $changed = [];
        $fieldsManager = static::getFieldsManager();
        if (!$fields) {
    ...
    public function insert($fields = [])
    {
        ...
        $pk = $query->insert(static::getTableName(), $prepared);
        $pkAttribute = $this->getPkAttribute();
        
        $field = static::getFieldsManager()->getField($pkAttribute);
    ...
    public function update($fields = [])
    {
        ...
        $query = static::getQuery();
        $result = $query->update(static::getTableName(), [$this->getPkAttribute() => $this->getPk()], $prepared);
    ...
    public function delete()
    {
        ...
        $query = static::getQuery();
        $result = $query->delete(static::getTableName(), [$this->getPkAttribute() => $this->getPk()]);
